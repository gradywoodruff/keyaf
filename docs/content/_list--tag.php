		<style>
			.page--subject-<?php single_tag_title(); ?> .link--subject-<?php single_tag_title(); ?> {
				color: #2E2232;
				...
				<div class="tutorial">
					...
					<div class="tutorial__meta">
						...
						<div class="tutorial__meta_producer">
							<a href="<?php echo $producerUrl ?>" class="link link--producer link--producer-<?php echo $producerName ?>" alt="Producer: <?php echo $producerName ?>" title="KEYAF Tutorials for songs produced by <?php echo $producerName ?>"><?php echo $producerName ?></a>
						</div>
